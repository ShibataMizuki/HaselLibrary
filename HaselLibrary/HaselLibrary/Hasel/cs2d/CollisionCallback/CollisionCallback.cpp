...
hasel::cs2d::Callback::Callback(int attributeA, int attributeB,const std::function<void(const wptr<RigidBody>&, const wptr<RigidBody>&,const CollisionInfo&)>& callback):
...
void hasel::cs2d::Callback::operator()(const wptr<RigidBody>& bodyA, const wptr<RigidBody>& bodyB,const CollisionInfo& info)const
{
